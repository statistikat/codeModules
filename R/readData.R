...
#' @param symbol Optional: A symbol to use in the import code in place of the path. This is useful if the
#'               path has previously been saved as a variable.
...
#'
#' }
readData <- function(input, output, session, path, callback = function(){}, symbol = NULL){
  fileType <- reactive({
